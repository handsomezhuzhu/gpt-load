export default {
  ...
  keys: {
    ...
    invalid: "無効",
    cooldown: "クールダウン中",
    cooldownShort: "クールダウン",
    cooldownExpired: "まもなく回復",
    cooldownRemainingHours: "残り{hours}時間{minutes}分",
    cooldownRemainingMinutes: "残り{minutes}分",
    cooldownRemainingSeconds: "残り{seconds}秒",
    checking: "チェック中",
    unchecked: "未チェック",
